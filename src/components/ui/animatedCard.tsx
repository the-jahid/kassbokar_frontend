...
export function CardDemo() {
    return (
        <Card>
            ...
            <CardTitle>With Kassbokar AI</CardTitle>
            
                <ul className="list-disc list-inside">
                    <li>Top Tier Business In minutes</li>
                    <li>100+ public and private data sources</li>
                    <li>Unparalleled accuracy and industry coverage</li>
                    <li>In-depth insights rivaling leading firms</li>
...
export const Card = ({
    ...
    return (
        <div
            className={cn(
                " w-4/6 m:w-4/5 mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
                className
            )}
        >
            {children}
